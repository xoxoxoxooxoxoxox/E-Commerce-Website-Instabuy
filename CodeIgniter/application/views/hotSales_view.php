      ...
      <div class = "logo"> Insta<strong>buy</strong></div>
        <div class = "menu">
          <ul class = "solidblockmenu">
            <li value = "h"><a href = "http://localhost:8436/CodeIgniter/index.php/instabuy/index">Home</a></li>
            <li value = "t" class = "active"><a href = "http://cs-server.usc.edu:8436/CodeIgniter/index.php/instabuy/technologies">Technologies</a></li>
    ...
    <div class = "body-wrapper col-7">
      <?php if (!empty($sales)):?>
        <?php foreach ($sales as $row):?>
          <?php if ($date >= $row['sdate'] && $date <= $row['edate']): ?>
            <div class = "productShowDiv">
              <table class = "productTable">
                <tr>
                  <th><a href = "salesProduct/<?php echo $row['productID'];?>"><?php echo $row['productName']; ?></a></th>
                </tr>
                <tr>
                ...
                <tr>
                  <td>Orignal Price: <div style = "display: inline;"><?php echo '$'.$row['price'] ?></div></td>
                </tr>
                <tr>
                  <td style = "color: red; font-size: 1.5em;">Sales Price: <strong><?php echo '$'.$row['finalPrice'] ?></strong></td>
                </tr>
              </table>
            </div>
          <?php endif; ?>
